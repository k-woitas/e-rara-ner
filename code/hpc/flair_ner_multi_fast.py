...
corpus['flair-ner-multi-fast'] = ''
for index in corpus.index[50:176]:
    ...
    for s in sentences:
        for token in s.tokens:
            ...
            if tag.value in ['S-LOC', 'B-LOC', 'E-LOC', 'I-LOC']:
                ...
                corpus['flair-ner-multi-fast'][index] = loc_ents
    outfile = "corpus_bernensia_ger_LOC_flair-ner-multi-fast.csv"
    with open(outfile, "w") as f:
        corpus.to_csv(f, index=False, columns=['e_rara_id', 'flair-ner-multi-fast'])
